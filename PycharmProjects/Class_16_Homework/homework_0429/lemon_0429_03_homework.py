...
# 方法一、二：
# from Class_16_Homework.unittest_0429.lemon_0426_03_homework_3 import TestMinus, TestDivide

# 方法三、四：
from Class_16_Homework.unittest_0429 import lemon_0426_03_homework_3 as module1
...
# 进一步美化报告
with open('test_result_3.html', mode='wb') as file:
    runner = HTMLTestRunnerNew.HTMLTestRunner(stream=file,
                                              title='第一份测试报告',
                                              verbosity=2,
                                              description='测试两数相减和相除用例',
                                              tester='dranson')
    runner.run(suite)
