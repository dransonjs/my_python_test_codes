...
from Class_16_Homework.practice.lemon_0419_07_homework import MathCalculate
...
class TestDivide(unittest.TestCase):
    ...
    def test_case(self, case_value):
        ...
        #         MathCalculate(l_data, r_data).divide()
        #
        #     self.file.write('{}，执行结果：{}\n'.format(msg, 'pass'))
        #     self.handle_excel.write_result(case_id + 1, 'ZeroDivisionError', 'Pass')
        ...
        try:
            ...
            # self.handle_excel.write_result(case_id + 1, MathCalculate(l_data, r_data).divide(), 'Fail')
