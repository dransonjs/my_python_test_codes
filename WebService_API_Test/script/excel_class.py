...
"""
-------------------------------------------------
  @Time : 2019/5/13 20:17 
  @Auth : 可优
  @File : lemon_01_excel_handle_1.py
  @IDE  : PyCharm
...
class HandleExcel(object):
    ...
    def __init__(self, filename, sheetname=None):
        ...
        # if self.sheetname is None:  # 如果没有传sheetname这个参数，那么默认获取当前活跃表单
...
if __name__ == '__main__':
    one_excel = HandleExcel(filename=DATA_FILE_PATH)
